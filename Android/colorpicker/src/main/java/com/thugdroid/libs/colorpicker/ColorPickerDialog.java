...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    AlertDialog.Builder builder = new AlertDialog.Builder(requireActivity()).setView(rootView)
        ...
        }).setNegativeButton(R.string.cpv_cancel, new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                onDialogDismissed();
              }
  ...
  public static final class Builder {
    ...
    public Builder setColorPickerListener(ColorPickerDialogListener colorPickerListener){
      this.colorPickerDialogListener=colorPickerListener;
      return this;
    }
    ...
    public ColorPickerDialog create() {
      ...
      dialog.setColorPickerDialogListener(this.colorPickerDialogListener);
