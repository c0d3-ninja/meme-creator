...
public class ColorPickerView extends View {
  ...
  /**
   * The radius in px of the color palette tracker rounded_rectangle_iconprimary.
   */
   ...
   * We can reuse it when the user is sliding the rounded_rectangle_iconprimary picker as long as the hue isn't changed.
   */
