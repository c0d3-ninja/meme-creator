package com.thugdroid.libs.zoomableimageview;
...
public class ZoomableImageView extends View {
    ...
    //long press
    private OnImageLongPressListener mImageLongPressListener;
    ...
    //Set longpress listener
    public void setOnImageLongPressListener(OnImageLongPressListener mImageLongPressListener) {
        this.mImageLongPressListener = mImageLongPressListener;
    }
...
//            Log.v("scrolling===>"," "+getScale()+" "+zoomDefault() );
            // Scroll the bitmap
...
//            }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if ( getScale() > zoomDefault() ){
                zoomTo(zoomDefault(), e.getX(), e.getY(),200);
            }
...
//        }
        ...
        public void onLongPress(MotionEvent e) {
            super.onLongPress(e);
            if(mImageLongPressListener!=null){
                mImageLongPressListener.onImageLongPressed(getThisView());
            }
        }
    }
    ...
    public ZoomableImageView getThisView(){
        return this;
    }
    ...
    public interface OnImageDoubleTapListener {
        public void imageDoubleTapped(ZoomableImageView zoomableImageView);
    }
